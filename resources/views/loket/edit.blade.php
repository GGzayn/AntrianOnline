          ...
          <div class="box box-info">
              ...
              <!-- form start -->
                @foreach($loket as $row)
                    ...
                    <form action="{{route('adminUpt.lokets.update', $row->id)}}" method="post" class="form-horizontal">
                    @endif
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_loket" class="form-control" id="nama_loket" value="{{$row->nama_loket}}" placeholder="Nama Loket" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input required type="text" name="waktu_buka" class="form-control" id="waktu_buka" value="{{$row->waktu_buka}}" placeholder="Waktu Buka">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input required type="text" name="waktu_tutup" class="form-control" id="waktu_tutup" value="{{$row->waktu_tutup}}" placeholder="Waktu Tutup">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input required type="number" name="interval_waktu" class="form-control" id="interval_waktu" value="{{$row->interval_waktu}}" placeholder="Interval Waktu Dalam menit">
                            </div>
                        </div>
